...
export function createIceCandidatePairStats() {
    return {
...
export function createIceCandidateStats() {
    return {
...
export function createLocalAudioTrackStats() {
    return {
...
export function createRemoteAudioTrackStats() {
    return {
...
export function createStatsReport() {
    return {
