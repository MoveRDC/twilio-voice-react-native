...
let MockInvalidArgumentError;
let mockGetErrorsByCode;
let MockTwilioError;
...
describe('constructTwilioError', () => {
    it('should throw if passed an invalid message', () => {
        expect(() => constructTwilioError(null)).toThrowError(MockInvalidArgumentError);
    ...
    it('should throw if passed an invalid code', () => {
        expect(() => constructTwilioError('foobar', null)).toThrowError(MockInvalidArgumentError);
        expect(MockInvalidArgumentError.mock.calls).toEqual([
