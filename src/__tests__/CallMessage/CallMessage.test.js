...
describe('validateCallMessage', () => {
    ...
    it('should throw an error if content is null', () => {
        ...
        expect(() => validateCallMessage(invalidMessage)).toThrow('"content" must be defined and not "null".');
    });
    ...
    it('should throw an error if the messageType is not a string', () => {
        ...
        const testMessageType = (messageType) => {
            ...
            expect(() => validateCallMessage(invalidMessage)).toThrow('"messageType" must be of type "string".');
        };
    ...
    it('should throw an error if the contentType is defined and not a string', () => {
        ...
        const testContentType = (contentType) => {
            ...
            expect(() => validateCallMessage(invalidMessage)).toThrow('If "contentType" is present, it must be of type "string".');
        };
